...
void PairDft::read_file(char *filename)
{
...
void PairDft::interpolate(int n, double delta, double *f, double **spline)
{
...
int PairDft::pack_forward_comm(int n, int *list, double *buf, int /*pbc_flag*/, int * /*pbc*/)
{
  int i,j,m;
...
void PairDft::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairDft::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairDft::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
